...
{
  echo "# GENERATED by Push.ps1 or push.sh; future pushes overwrite this file."
  echo "# Required only as input to Deploy.ps1 or deploy.sh for immutable image URIs."
  echo "# Not read by running containers or the already-deployed AWS stack."
  echo "# Gitignored and account-specific. Do not add credentials or access tokens."
