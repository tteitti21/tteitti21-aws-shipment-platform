...
@(
    "# GENERATED by Push.ps1 or push.sh; future pushes overwrite this file."
    "# Required only as input to Deploy.ps1 or deploy.sh for immutable image URIs."
    "# Not read by running containers or the already-deployed AWS stack."
    "# Gitignored and account-specific. Do not add credentials or access tokens."
